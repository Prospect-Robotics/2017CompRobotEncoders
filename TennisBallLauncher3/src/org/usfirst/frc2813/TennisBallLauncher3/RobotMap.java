...
public class RobotMap {
	...
	public static void init() {
        ...
        driveTrainSpeedController1 = new PWMSplitter(new Spark(0), new Spark(1), new Spark(2));
        driveTrainSpeedController1.setInverted(true);
        
        ((Sendable) driveTrainSpeedController1).setName("DriveTrain", "Speed Controller 1");
        
        driveTrainSpeedController2 = new PWMSplitter(new Spark(3), new Spark(4), new Spark(5));
