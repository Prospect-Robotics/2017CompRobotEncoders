 ...
 *
 */
public class PrintOutRawValueOverTime extends Command {
    ...
    public PrintOutRawValueOverTime(int time, Encoder myEncoder1, Encoder myEncoder2, Encoder myEncoder3) {
    ...
    protected void execute() {
    	if((System.currentTimeMillis() - last) >= 100) {
	    	System.out.println(
	    			...
	    			myEncoder3.get() + " [" + myEncoder3.getRaw() + "] " +myEncoder3.getDistance()+" "+ myEncoder3.getDistance()*19.25 +" ["+myEncoder3.getDistancePerPulse()+"] "+myEncoder3.getDirection()+" ["+myEncoder3.getStopped()+"]\n"
	    			);
